...
const MobileNavBar = ({ user }) => {
    ...
    return (
        <nav className="w-full bg-[#020817] border-b border-gray-800 px-2 py-2 flex flex-col gap-2 md:hidden relative">
            {/* Dropdown Search Bar */}
            {showSearch && (
                <div ref={searchRef} className="absolute top-0 left-0 w-full z-50 bg-[#020817] px-2 py-2 border-b border-blue-400 animate-fade-in-down">
                    <form
                    ...
                    >
                        <Input
                            ...
                            type="text"
                            className="w-full pr-10 pl-4 py-2 rounded-full border border-blue-400 bg-zinc-900 text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition text-sm"
                        ...
                        {showSuggestions && searchQuery && (
                            <ul className="absolute left-0 right-0 top-12 z-50 bg-zinc-900 border border-zinc-800 rounded-b-xl shadow-lg max-h-60 overflow-y-auto">
                                ...
                                <li
                                    ...
                                    onMouseDown={() => handleSuggestionClick({ title: searchQuery })}
                                >
            ...
            {/* Top Row: Logo, Explore, [Search, Chat, Avatar] */}
            <div className="flex items-center justify-between w-full">
                <div className="flex items-center gap-2">
                    ...
                    <a
                        href="#our-courses"
                        className="text-blue-400 font-semibold text-base hover:underline transition ml-2"
                        onClick={e => {
                            e.preventDefault();
                ...
                <div className="flex items-center gap-0">
                    <Button
                        variant="ghost"
                        className="rounded-full p-0 text-blue-400 hover:text-blue-500"
