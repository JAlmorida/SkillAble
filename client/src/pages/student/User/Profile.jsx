...
import { Loader2, Shuffle, Camera } from "lucide-react";
...
const Profile = () => {
  ...
  if (!data?.user) return <h1>No profile data found</h1>;
          ...
          <Dialog>
            ...
            <DialogContent>
              ...
              <div className="grid gap-4 py-4">
                {/* Avatar preview and random avatar button */}
                <div className="flex flex-col items-center gap-2 mb-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      setProfilePicture(""); // Clear file input if any
